...
class Messaging {
  ...
  @visibleForTesting
  Messaging.private(MethodChannel channel, Platform platform)
      : _channel = channel,
        _platform = platform;

  static final Messaging _instance = Messaging.private(
      const MethodChannel('com.yangio.plugin/messaging'),
      const LocalPlatform());
  ...
  Future<void> clearStack() async {
    ...
    // https://github.com/flutter/flutter/issues/26431
    // ignore: strong_mode_implicit_dynamic_method
    return await _channel.invokeMethod('clearNativeStack');
  }
  ...
  Future<bool> goSystemSettings() async {
    return await _channel.invokeMethod('goSettings');
  }
  ...
  void setAlias(String alias) {
    // ignore: strong_mode_implicit_dynamic_method
    _channel.invokeMethod('setAlias', alias);
  }

  void removeAlias(String alias) {
    // ignore: strong_mode_implicit_dynamic_method
    _channel.invokeMethod('removeAlias', alias);
  }
